...
async function main() {
  ...
  console.log('Completing Requirements for Gig 3 on:', page.url());
  ...
  // 2. Type requirements
  const reqText = '1. Approximate number of B2B customers requiring access. 2. Priority features (login, stock view, contract prices, re-order). 3. Business Central version and current API access. 4. Brand preferences (logo, color scheme).';
  ...
  const img1 = '/Users/teddy/teddy-apps/marketing/assets/fiverr/b2b-portal-01.png';
  const img2 = '/Users/teddy/teddy-apps/marketing/assets/fiverr/b2b-portal-02.png';
  const img3 = '/Users/teddy/teddy-apps/marketing/assets/fiverr/b2b-portal-03.png';
  ...
  const shot = path.join(__dirname, 'gig3_gallery_done.png');
  ...
  const publishShot = path.join(__dirname, 'gig3_final_publish_step.png');
